...
<p> Registered and published extensions are listed below, grouped by
    ...
    appendices of the
    <a href="specs/1.0-extensions/xhtml/vkspec.html"> Vulkan 1.0 Core API +
    all published Extensions</a> document. </p>

<ul>
    <li> <b> Khronos-approved Extensions </b> </li>
    <li> <a href="specs/1.0-extensions/xhtml/vkspec.html#VK_KHR_android_surface">                  VK_KHR_android_surface </li>
    <li> <a href="specs/1.0-extensions/xhtml/vkspec.html#VK_KHR_display">                          VK_KHR_display </li>
    <li> <a href="specs/1.0-extensions/xhtml/vkspec.html#VK_KHR_display_swapchain">                VK_KHR_display_swapchain </li>
    <li> <a href="specs/1.0-extensions/xhtml/vkspec.html#VK_KHR_mir_surface">                      VK_KHR_mir_surface </li>
    <li> <a href="specs/1.0-extensions/xhtml/vkspec.html#VK_KHR_surface">                          VK_KHR_surface </li>
    <li> <a href="specs/1.0-extensions/xhtml/vkspec.html#VK_KHR_swapchain">                        VK_KHR_swapchain </li>
    <li> <a href="specs/1.0-extensions/xhtml/vkspec.html#VK_KHR_wayland_surface">                  VK_KHR_wayland_surface </li>
    <li> <a href="specs/1.0-extensions/xhtml/vkspec.html#VK_KHR_win32_surface">                    VK_KHR_win32_surface </li>
    <li> <a href="specs/1.0-extensions/xhtml/vkspec.html#VK_KHR_xcb_surface">                      VK_KHR_xcb_surface </li>
    <li> <a href="specs/1.0-extensions/xhtml/vkspec.html#VK_KHR_xlib_surface">                     VK_KHR_xlib_surface </li>
    <li> <b> Multivendor Extensions </b> </li>
    <li> <a href="specs/1.0-extensions/xhtml/vkspec.html#VK_EXT_debug_marker">                     VK_EXT_debug_marker </li>
    <li> <a href="specs/1.0-extensions/xhtml/vkspec.html#VK_EXT_debug_report">                     VK_EXT_debug_report </li>
    <li> <a href="specs/1.0-extensions/xhtml/vkspec.html#VK_EXT_validation_flags">                 VK_EXT_validation_flags </li>
    <li> <b> AMD Vendor Extensions </b> </li>
    <li> <a href="specs/1.0-extensions/xhtml/vkspec.html#VK_AMD_draw_indirect_count">              VK_AMD_draw_indirect_count </li>
    <li> <a href="specs/1.0-extensions/xhtml/vkspec.html#VK_AMD_gcn_shader">                       VK_AMD_gcn_shader </li>
    <li> <a href="specs/1.0-extensions/xhtml/vkspec.html#VK_AMD_negative_viewport_height">         VK_AMD_negative_viewport_height </li>
    <li> <a href="specs/1.0-extensions/xhtml/vkspec.html#VK_AMD_rasterization_order">              VK_AMD_rasterization_order </li>
    <!-- <li> <a href="specs/1.0-extensions/xhtml/vkspec.html#VK_AMD_shader_ballot">                    VK_AMD_shader_ballot </li> -->
    <li> <a href="specs/1.0-extensions/xhtml/vkspec.html#VK_AMD_shader_explicit_vertex_parameter"> VK_AMD_shader_explicit_vertex_parameter </li>
    <li> <a href="specs/1.0-extensions/xhtml/vkspec.html#VK_AMD_shader_trinary_minmax">            VK_AMD_shader_trinary_minmax </li>
    <li> <b> Imagination Vendor Extensions </b> </li>
    <li> <a href="specs/1.0-extensions/xhtml/vkspec.html#VK_IMG_filter_cubic">                     VK_IMG_filter_cubic </li>
    <li> VK_IMG_format_pvrtc (<i>Registered, but not currently documented</i>) </li>
    <li> <b> NVIDIA Vendor Extensions </b> </li>
    <li> <a href="specs/1.0-extensions/xhtml/vkspec.html#VK_NV_dedicated_allocation">              VK_NV_dedicated_allocation </li>
    <li> <a href="specs/1.0-extensions/xhtml/vkspec.html#VK_NV_external_memory">                   VK_NV_external_memory </li>
    <li> <a href="specs/1.0-extensions/xhtml/vkspec.html#VK_NV_external_memory_capabilities">      VK_NV_external_memory_capabilities </li>
    <li> <a href="specs/1.0-extensions/xhtml/vkspec.html#VK_NV_external_memory_win32">             VK_NV_external_memory_win32 </li>
    <li> <a href="specs/1.0-extensions/xhtml/vkspec.html#VK_NV_glsl_shader">                       VK_NV_glsl_shader </li>
    <li> <a href="specs/1.0-extensions/xhtml/vkspec.html#VK_NV_win32_keyed_mutex">                 VK_NV_win32_keyed_mutex </li>
</ul>
