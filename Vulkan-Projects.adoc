...
* *NOTE* Vulkan-Headers is just a staging area collecting files generated from other repositories. If you find a problem with anything in Vulkan-Headers, refer to the  https://github.com/KhronosGroup/Vulkan-Headers/README.md[repository README] to determine where to report that problem.
